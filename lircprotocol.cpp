...
//    emit errorMessage("Key not defined in this keyset.");
    std::cout << "Key not defined in this keyset." << std::endl;
    return;
  }
...
//  std::cout << "About to send key." << std::endl;
...
//    std::cout << "About to sleep until repeat." << std::endl;

    // sleep until the next repetition of command:
    sleepUntilRepeat(commandDuration);

//    std::cout << "repeatCount vs minimumRepetitions." << repeatCount << ", " << minimumRepetitions << std::endl;
